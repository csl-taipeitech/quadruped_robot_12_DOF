...
class RobotControl:
    ...
    def puppy_move(self, left_leg_move=1, right_leg_move=1, leg_height=15):
        while self.t <= 1:
            # Calculate foot locations based on gait
...
class RobotIK():
    ...
    def leg_inverse_kinematics(self, foot_locations):
        ...
        print("upper_leg_1", upper_leg_1 * 180 / 3.14)
        print("lower_leg_1", lower_leg_1 * 180 / 3.14)
    ...
    def lower_leg_angle_to_servo_angle(self, THETA2, THETA3):
        ...
        DGF,GFE,FED = self.calculate_4_bar(THETA3,self.linkage.i,self.linkage.g,self.linkage.f,self.linkage.h) #+ link.lower_leg_bend_angle
...
class Leg_linkage:
    def __init__(self):
        ...
        self.d = 35.23  #mm
        self.e = 67.1 #mm
        self.f = 65 #mm  #new will be 130.0
        self.g = 19 #mm
        self.h = 19 #mm
        self.lower_leg_bend_angle = radians(0) # degrees found on CAD
        self.i = 65
