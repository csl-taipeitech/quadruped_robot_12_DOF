...
def generate_launch_description():
    ...
    pkg_dir = get_package_share_directory('fooldog_urdf')
    urdf_path = os.path.join(pkg_dir, 'urdf', 'fooldog_urdf.urdf')
    ...
    description_ld = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            os.path.join(
                get_package_share_directory("fooldog_urdf"),
                "launch",
