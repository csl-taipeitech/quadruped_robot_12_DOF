...
class RobotControl:
    ...
    def get_jointAngle_data(self):
        ...
        required_keys = ['fru', 'flu', 'bru', 'blu', 'frd', 'fld', 'brd', 'bld', 'fr', 'fl', 'br', 'bl']
    ...
    def motor_position_control(self, position=None):
        if position is None:
            position = [[2048 ,2048, 2048, 2048], 
                        ...
                        [2048 ,2048, 2048, 2048]] 
            '''
            The default position for all motors is 2048, but the height changes too fast. 
            So, I made some adjustments to increase the body height in reset mode.
            '''
